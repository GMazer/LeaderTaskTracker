...
export const ProjectForm: React.FC<ProjectFormProps> = ({ initialProject, onSave, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl w-full max-w-md flex flex-col transition-colors duration-200">
        ...
        <form id="projectForm" onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all placeholder-gray-400 dark:placeholder-slate-500"
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all resize-none placeholder-gray-400 dark:placeholder-slate-500"
        ...
        <div className="p-6 border-t border-gray-100 dark:border-slate-700 flex justify-end gap-3 bg-gray-50 dark:bg-slate-700/30 rounded-b-3xl">
          <button onClick={onClose} className="px-6 py-2.5 rounded-xl text-gray-700 dark:text-slate-300 font-medium hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors">
            Hủy
          </button>
          <button
            type="submit"
