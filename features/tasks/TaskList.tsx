            ...
            >
              <div className="p-5 flex flex-col md:flex-row gap-4 relative">
                ...
                <div className="flex-1 space-y-3 min-w-0">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="relative">
                      <select 
                        ...
                        className={`appearance-none pl-9 pr-8 py-2 rounded-xl text-xs font-semibold border cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-1 dark:focus:ring-offset-slate-800 ${STATUS_COLORS[task.status]}`}
                  ...
                  <p className="text-gray-600 dark:text-slate-300 text-sm line-clamp-2 leading-relaxed">{task.description}</p>
                  ...
                  <div className="flex flex-wrap items-center gap-4 pt-3 border-t border-gray-50 dark:border-slate-700/50 mt-2">
                    ...
                    {task.attachments.length > 0 && (
                      <div className="flex items-center gap-1 text-xs text-gray-500 dark:text-slate-400 bg-gray-50 dark:bg-slate-700 px-3 py-1.5 rounded-xl">
                        <Paperclip size={12} />
